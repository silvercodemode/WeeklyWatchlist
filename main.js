...
const storeShowInUsersWatchlist =
    async (showObject, username) => {
...
const getSortedShowObjectFromQuery =
    querySnapshot => {
...
const convertNumericMonthToString =
    numericMonth => {
        switch (numericMonth) {
...
const convertNumericWeekdayToString =
    numericWeekday => {
...
const getNumberOfEpisodesOut =
    (airDateString, currentDate, totalEpisodes) => {
...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('/WeeklyWatchlist/serviceworker.js', {scope: '/WeeklyWatchlist/'})
        .then(reg => {
...
const weekdayColumns = [mondayColumn, tuesdayColumn, wednesdayColumn, thursdayColumn, fridayColumn, saturdayColumn, sundayColumn]
